# File: routing.py
"""This module converts GPS coordinates to SUMO network edge data and finds pedestrian routes"""
...
def find_route(start_edge, end_edge):
    ...
    for _ in range(3):
        ...
        route = traci.simulation.findRoute(
            ...
            depart=0,
            routingMode=route_type,
        )

        filtered_route = [
            edge
            for edge in route.edges
            if not edge.startswith(":") and edge not in config.congested_lanes
        ]
