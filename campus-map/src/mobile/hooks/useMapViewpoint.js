...
import { UserLocationContext } from '../contexts/UserLocationContext'; // Get user location status
import { IndoorViewContext } from '../contexts/IndoorViewContext'; // Check if indoor view is active
import { SearchContext } from '../contexts/SearchContext'; // Check if a search result is selected

// Import or define helpers and constants
import { defaultCenter } from '../components/GoogleMapCore'; // Assuming defaultCenter is exported
...
const useMapViewpoint = () => {
  ...
  const lastAppliedViewpoint = useRef(null);
